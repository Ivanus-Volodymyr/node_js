...
import { cookie, emailActionEnums } from '../constans';
import {
    tokenService, emailService, userService, authService,
} from '../services';
...
class AuthController {
    ...
    public async login(req:IRequestExtended, res:Response, next:NextFunction) {
        try {
            ...
            await emailService.sendMail(emailActionEnums.WELCOME, email);
